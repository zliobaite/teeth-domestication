...
pdf('plots/fig_pca.pdf',height = 15, width = 15)
...
mycol <- c( "#0072B2", "#56B4E9", "#E69F00","#CC79A7", "#D55E00",  "#009E73", "#999999")
plot(NA,NA,xlim = c(1,68),ylim = c(0,100),ylab = 'Potential domestication rate, %', xlab = 'Number of best candidates to domesticate')
lines(c(10,10),c(0,100),col = 'lightgrey',type = 'l')
lines(data_rates[rg1,1],data_rates[rg1,7],type='l',col = mycol[6], lwd = lw)
lines(data_rates[rg1,1],data_rates[rg1,6],type='l',col = mycol[5], lwd = lw)
lines(data_rates[rg1,1],data_rates[rg1,5],type='l',col = mycol[4], lwd = lw)
lines(data_rates[rg1,1],data_rates[rg1,4],type='l',col = mycol[3], lwd = lw)
lines(data_rates[rg1,1],data_rates[rg1,2],type='l',col = mycol[1], lwd = lw)
lines(data_rates[rg1,1],data_rates[rg1,3],type='l',col = mycol[2], lwd = lw)
lines(data_rates[rg2,1],data_rates[rg2,7],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,6],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,5],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,4],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,2],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,3],type='l',col = 'lightgrey', lwd = 1)

points(10,27.27,col = mycol[2], cex = 1.3,lwd = 4)
points(10,0,col = mycol[1], cex = 1.3,lwd = 4)
points(10,28.57,col = mycol[6], cex = 1.3,lwd = 4)
points(9.7,0,col = mycol[3], cex = 1.1,lwd = 4,pch=4)
points(10,14.28,col = mycol[4], cex = 1.1,lwd = 4,pch=4)
points(10.3,0,col = mycol[5], cex = 1.1,lwd = 4,pch=4)
legend(12,100,realms[ord_cont],lty = 1,col = mycol[ord_cont], cex = 0.75, lwd = lw, bty = "n")
dev.off()

pdf('plots/fig_precision_bw.pdf', width = 6.5, height = 5)
rg1 <- 2:20
rg2 <- 20:69
lw <- 4
ord_cont <- c(2,1,6,3,4,5)
plot(NA,NA,xlim = c(1,68),ylim = c(0,100),ylab = 'Potential domestication rate, %', xlab = 'Number of best candidates to domesticate')
lines(c(10,10),c(0,100),col = 'lightgrey',type = 'l')
lines(data_rates[rg1,1],data_rates[rg1,3],type='l',col = 'darkgrey', lwd =5)
lines(data_rates[rg1,1],data_rates[rg1,2],type='l',col = 'black', lwd = 5)
lines(data_rates[rg1,1],data_rates[rg1,7],type='l',col = 'lightgrey', lwd = 5)
lines(data_rates[rg1,1],data_rates[rg1,4],type='l',col = 'darkgrey', lwd = 3,lty=5)
lines(data_rates[rg1,1],data_rates[rg1,5],type='l',col = 'black', lwd = 3,lty=5)
lines(data_rates[rg1,1],data_rates[rg1,6],type='l',col = 'lightgrey', lwd = 3,lty=5)
lines(data_rates[rg2,1],data_rates[rg2,7],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,6],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,5],type='l',col = 'lightgrey', lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,4],type='l',col = 'lightgrey', lwd = 1)
...
points(10,27.27,col = 'darkgrey', cex = 1.2,lwd = 5)
points(10,0,col = 'black', cex = 1.2,lwd = 5)
points(10,28.57,col = 'lightgrey', cex = 1.2,lwd = 5)
points(9.7,0,col = 'darkgrey', cex = 1.1,lwd = 3,lty=5,pch=4)
points(10,14.28,col = 'black', cex = 1.1,lwd = 3,lty=5,pch=4)
points(10.3,0,col = 'lightgrey', cex = 1.1,lwd = 3,lty=5,pch=4)
legend(12,100,realms[ord_cont],col = c('darkgrey','black','lightgrey','darkgrey','black','lightgrey'), cex = 0.75, lwd = c(5,5,5,3,3,3), lty = c(1,1,1,5,5,5),bty = "n")
dev.off()
