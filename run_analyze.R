...
lines(data_rates[rg2,1],data_rates[rg2,7],type='l',col = mycol[7], lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,6],type='l',col = mycol[7], lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,5],type='l',col = mycol[7], lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,4],type='l',col = mycol[7], lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,2],type='l',col = mycol[7], lwd = 1)
lines(data_rates[rg2,1],data_rates[rg2,3],type='l',col = mycol[7], lwd = 1)
